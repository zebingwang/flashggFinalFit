...
for ((iBin=0; iBin<$nMass; iBin++))
    ...
    ####python makeParametricModelDatacard_ALP_UL_v2.py -i ./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_16_ele.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_16APV_ele.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_17_ele.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_18_ele.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_16_mu.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_16APV_mu.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_17_mu.root,./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/CMS-HGG_sigfit_data_ggh_cat0_18_mu.root -s ./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_ele/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_16.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_ele/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_16APV.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_ele/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_17.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_ele/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_18.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_mu/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_16.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_mu/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_16APV.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_mu/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_17.dat,./ALP_sys_UL/shapeSys/fit_run2_UL_ScaleSmear_mu/ScaleSmear_plot/M${massList[$iBin]}/ScaleSmear_m${massList[$iBin]}_18.dat -o ./ALP_SigModel_param_${version}/fit_results_runII/M${massList[$iBin]}/datacard_ALPmass${massList[$iBin]}.txt --NormSys ./ALP_sys_UL/NormSys/NormalizationSys_16_ele.txt,./ALP_sys_UL/NormSys/NormalizationSys_16APV_ele.txt,./ALP_sys_UL/NormSys/NormalizationSys_17_ele.txt,./ALP_sys_UL/NormSys/NormalizationSys_18_ele.txt,./ALP_sys_UL/NormSys/NormalizationSys_16_mu.txt,./ALP_sys_UL/NormSys/NormalizationSys_16APV_mu.txt,./ALP_sys_UL/NormSys/NormalizationSys_17_mu.txt,./ALP_sys_UL/NormSys/NormalizationSys_18_mu.txt --BDTSys ./ALP_sys_UL/BDTSys/BDTSys_16_ele.txt,./ALP_sys_UL/BDTSys/BDTSys_16APV_ele.txt,./ALP_sys_UL/BDTSys/BDTSys_17_ele.txt,./ALP_sys_UL/BDTSys/BDTSys_18_ele.txt,./ALP_sys_UL/BDTSys/BDTSys_16_mu.txt,./ALP_sys_UL/BDTSys/BDTSys_16APV_mu.txt,./ALP_sys_UL/BDTSys/BDTSys_17_mu.txt,./ALP_sys_UL/BDTSys/BDTSys_18_mu.txt -p ggH_16_ele,ggH_16APV_ele,ggH_17_ele,ggH_18_ele,ggH_16_mu,ggH_16APV_mu,ggH_17_mu,ggH_18_mu -c cat0 --isMultiPdf -m 125 --mA ${massList[$iBin]}
    ...
    #combineTool.py -d datacard_ALPmass${massList[$iBin]}.txt -M HybridNew --LHCmode LHC-limits --singlePoint 0.01:0.2:0.0002 --saveToys --saveHybridResult -T 1000 --clsAcc 0 --rAbsAcc 0 -m 125 --freezeParameters MH  --job-mode condor --task-name M${massList[$iBin]} --sub-opts='+JobFlavour="testmatch"'
    #combineTool.py -d datacard_ALPmass${massList[$iBin]}.txt -M HybridNew --LHCmode LHC-limits --singlePoint 0.07:0.6:0.001 --saveToys --saveHybridResult -T 1000 --clsAcc 0 --rAbsAcc 0 -m 125 --freezeParameters MH  --job-mode condor --task-name M${massList[$iBin]} --sub-opts='+JobFlavour="testmatch"'
    ...
    # Global significance
    #combine datacard_ALPmass${massList[$iBin]}.root -M GenerateOnly --toysFrequentist -m 125 -t 1000 --saveToys --expectSignal=0
    
    #for j in $(seq 24 1000)
    #    do
    # for i in $(seq 95 180)
    #     do 
    #     combine datacard_ALPmass${massList[$iBin]}.root -M Significance -m 125 --redefineSignalPOI r --setParameters MH=$i --freezeParameters MH -n _m${i}_toy$1 -D higgsCombineTest.GenerateOnly.mH125.123456.root:toys/toy_$1 | tee -a toy_$1.txt
    #     echo "mH:${i}" | tee -a toy_$1.txt#
    #
    #     rm higgsCombine_m${i}_toy$1.Significance.mH125.root
    # done
    #done
