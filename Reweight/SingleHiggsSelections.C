...
void SingleHiggsSelections(){
TString Process = "VHToGG";
TString year = "2017";
TString input_node = "cHHH1";
TString InputFile = "/eos/user/a/atishelm/ntuples/HHWWgg_flashgg/January_2021_Production/2017/Single_H_2017_Hadded/" + Process + ".root";
TFile *output;
TString outputFile = "./" + Process  + "_applied_selections.root";
...
TString cat=(*i).c_str();
TString catName="tagsDumper/trees/wzh_125_13TeV_" + cat;
