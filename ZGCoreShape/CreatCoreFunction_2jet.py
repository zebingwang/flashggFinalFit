...
datafile_path = "./data_2jet.root"
Corefile_path = "./ZGCoreShape_2jet.root"
if os.path.exists(datafile_path):
    ...
    for jentry in range(ANF_tree.GetEntriesFast()):
        ...
        if ANF_tree.dijet_bdt_score_transfered > bdt_boundaries[0][0] and ANF_tree.dijet_bdt_score_transfered <= bdt_boundaries[0][1]:
            data_ANF["ZG_NAF_cat0"].add(rt.RooArgSet(H_mass_ANF))
        elif ANF_tree.dijet_bdt_score_transfered > bdt_boundaries[1][0] and ANF_tree.dijet_bdt_score_transfered <= bdt_boundaries[1][1]:
            data_ANF["ZG_NAF_cat1"].add(rt.RooArgSet(H_mass_ANF))
        elif ANF_tree.dijet_bdt_score_transfered > bdt_boundaries[2][0] and ANF_tree.dijet_bdt_score_transfered <= bdt_boundaries[2][1]:
            data_ANF["ZG_NAF_cat2"].add(rt.RooArgSet(H_mass_ANF))
        elif ANF_tree.dijet_bdt_score_transfered > bdt_boundaries[3][0] and ANF_tree.dijet_bdt_score_transfered <= bdt_boundaries[3][1]:
    ...
    for jentry in range(data_tree.GetEntriesFast()):
        ...
        if data_tree.dijet_bdt_score > bdt_boundaries[0][0] and data_tree.dijet_bdt_score <= bdt_boundaries[0][1]:
            data["data_cat0"].add(rt.RooArgSet(H_mass_ANF))
        elif data_tree.dijet_bdt_score > bdt_boundaries[1][0] and data_tree.dijet_bdt_score <= bdt_boundaries[1][1]:
            data["data_cat1"].add(rt.RooArgSet(H_mass_ANF))
        elif data_tree.dijet_bdt_score > bdt_boundaries[2][0] and data_tree.dijet_bdt_score <= bdt_boundaries[2][1]:
            data["data_cat2"].add(rt.RooArgSet(H_mass_ANF))
        elif data_tree.dijet_bdt_score > bdt_boundaries[3][0] and data_tree.dijet_bdt_score <= bdt_boundaries[3][1]:
...
if keysPdfs_plots:
    #for cat in ["ZG_NAF_cat0", "ZG_NAF_cat1", "ZG_NAF_cat2", "ZG_NAF_cat3"]:
    for cat in ["ZG_NAF_cat0", "ZG_NAF_cat1", "ZG_NAF_cat2", "ZG_NAF_cat3", "ZG_NAF_allcat"]:
        keysPdfs_plots[cat].SaveAs('./{}_2jet.png'.format(cat))
