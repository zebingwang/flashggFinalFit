...
do
  ...
  do
    ...
    SignalTreeFile="/eos/user/c/chuw/HHWWgg_ntuple/2018/Signal_cHHH2p45_2018_all_CategorizedTrees.root"
    DataTreeFile="/eos/user/a/atishelm/ntuples/HHWWgg_flashgg/January_2021_Production/2018/SL_DNN_Categorized_LOSignals_noPtOverM-Training/Data_2018_CategorizedTrees.root"
...
rm -rf ws*
cp /eos/user/c/chuw/HHWWgg_ntuple/2018/GluGluToHHTo2G2Qlnu_node_cHHH2p45_2018.root ./
