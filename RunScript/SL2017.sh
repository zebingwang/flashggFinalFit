...
do
  ...
  do
    ...
    SignalTreeFile="/eos/user/a/atishelm/ntuples/HHWWgg_flashgg/January_2021_Production/2017/SL_DNN_Categorized_LOSignals_noPtOverM-Training/Signal_cHHH1_2017_all_CategorizedTrees.root"
    DataTreeFile="/eos/user/c/chuw/HHWWgg_ntuple/2017/SL_DNN_Categorized_LOSignals_noPtOverM-Training/Data_2017_CategorizedTrees.root"
