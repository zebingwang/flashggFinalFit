...
nBins=( 200 200 150 300 250 190 200 200 200 200 150 50 180 200 150 200 200 200 200 150 200 180 155 200 80 250 150 320 120 230 200 200 200 300 250 200 295 150 250 250 200 200 200 200 300 200 300 200 220 230 110 140 200 150 150 200 ) ## Sum-n Gaus
#nBins=150
...
for ((iBin=0; iBin<$nMass; iBin++))
    ...
    #./bin/fTest_ALP -i $path_in_bkg/ALP_data_bkg_Am${massList[$iBin]}_workspace.root --saveMultiPdf $path_bkg/CMS-HGG_mva_13TeV_multipdf.root -D $path_bkg/HZAmassInde_fTest -c 1 --isFlashgg 0 --isData 0 -f data, --mhLow 110 --mhHigh 180  --mhLowBlind 115 --mhHighBlind 135
