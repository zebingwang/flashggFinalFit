...
cd ../Datacard
if [ ! -d "./SingleHiggs_${ext}" ]; then
  mkdir -p ./SingleHiggs_${ext}/
fi
rm Datacard*.txt
rm -rf yields_test/
#copy signal  and bkg model
cp ${path}/Signal/outdir_${ext}_${year}_single_Higgs/signalFit/output/CMS-HGG_sigfit_${ext}_${year}_single_Higgs_${procs}_${year}_${cat}.root ./SingleHiggs/CMS-HGG_sigfit_packaged_${procs}_${cat}_${year}.root 
