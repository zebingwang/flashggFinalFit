...
//=========  (Thu Apr  2 10:08:00 2020) by ROOT version 6.12/07
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(248.7143,-0.735463,251.0952,5.393399);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   Graph_Graph1->SetMinimum(7811.135);
   Graph_Graph1->SetMaximum(46722.04);
   ...
   Graph_Graph2->SetMinimum(13422.29);
   Graph_Graph2->SetMaximum(32699.91);
   ...
   Graph_Graph3->SetMinimum(21437.4);
   Graph_Graph3->SetMaximum(21438.6);
