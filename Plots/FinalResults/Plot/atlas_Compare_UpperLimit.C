void atlas_Compare_UpperLimit()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Mar 18 04:10:33 2020) by ROOT version 6.12/07
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(248.7143,-0.4267642,251.0952,3.129608);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   TH1F *hframe__1 = new TH1F("hframe__1","",1000,249,251);
   hframe__1->SetMinimum(1.000001);
   hframe__1->SetMaximum(700);
   ...
   hframe__1->GetYaxis()->SetTitle("95% CL limits on #sigma(gg#rightarrow X)#times B(X#rightarrow HH) [pb]");
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,248.8,251.2);
   Graph_Graph1->SetMinimum(7.479855);
   Graph_Graph1->SetMaximum(43.18839);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,248.8,251.2);
   Graph_Graph2->SetMinimum(12.66993);
   Graph_Graph2->SetMaximum(30.51654);
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Graph",100,248.8,251.2);
   Graph_Graph3->SetMinimum(20.025);
   Graph_Graph3->SetMaximum(21.225);
...
tex->SetNDC();
   ...
   TH1F *hframe__2 = new TH1F("hframe__2","",1000,249,251);
   hframe__2->SetMinimum(1.000001);
   hframe__2->SetMaximum(700);
   ...
   hframe__2->GetYaxis()->SetTitle("95% CL limits on #sigma(gg#rightarrow X)#times B(X#rightarrow HH) [pb]");
