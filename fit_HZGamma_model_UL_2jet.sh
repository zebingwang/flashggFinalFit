...
version='UL_run2_2jet_corefunction_v2_SB'
...
#python makeWorkspace_data_cats.py -t test -d ./jet2_run2_CoreFunc_v2/two_jet/data.root -j ./jet2_run2_CoreFunc_v2/significances/bin_binaries_1D_two_jet.txt -o ./jet2_run2_CoreFunc_v2 
#python makeWorkspace_sig_cats_vbf.py -t test -d ./jet2_run2_CoreFunc_v2/two_jet/sig.root -j ./jet2_run2_CoreFunc_v2/significances/bin_binaries_1D_two_jet.txt -o ./jet2_run2_CoreFunc_v2 
...
#path_in_bkg="../InputData/jet01_run2_CoreFunc_v2/HZGamma_data_bkg_workspace_$cat.root"
# 2 jets
#path_in_bkg="../InputData/jet2_run2/HZGamma_data_bkg_workspace_$cat.root"
path_in_bkg="../InputData/jet2_run2_CoreFunc_v2/HZGamma_data_bkg_workspace_$cat.root"
...
./bin/fTest_ALP_turnOn -i $path_in_bkg --saveMultiPdf $path_out_bkg/CMS-HGG_mva_13TeV_multipdf_$cat.root -D $path_out_bkg/HZGmassInde_fTest -c 1 --channel ${cat_name}_${cat} --isFlashgg 0 --isData 0 -f data, --mhLow 105 --mhHigh 170  --mhLowBlind 122 --mhHighBlind 128 --catID -1 --sidebandOnly #--verbose 2 #--chi2fit #--verbose 2 #--runFtestCheckWithToys #--sidebandOnly
...
for ((iCat=0; iCat<$ncats; iCat++))
  ...
  path_in_sig="../InputData/jet01_run2_CoreFunc_v2"
