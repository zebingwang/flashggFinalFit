...
do
  ...
  do
    ...
    TreeCats='"HHWWggTag_1"'
    TreePath="/afs/cern.ch/user/c/chuw/chuw/HHWWgg/WWZZ_Signal_Addition/"
    DataTreeFile="/afs/cern.ch/work/l/lipe/public/allData.root"
    doSelections="1"
    Selections='dipho_pt > 160' # Seletions you want to applied.
...
echo "python trees2ws.py --inputConfig HHWWgg_config_run.py --inputTreeFile ./${procs}_node_${node}_${year}.root --inputMass node_${node} --productionMode ${procs}  --year ${year} --doSystematics"
