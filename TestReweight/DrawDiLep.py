...
if __name__ == '__main__':
  ...
  output = ROOT.TFile("DiLeptonMass.root","RECREATE")
  output.Close()
  keys=['HH','bckg']
  for key in keys :
      print('key: ', key)
      ...
      for filen in fileNames:
          ...
          for tname in treename:
              ...
              #  if 'node' in tname:
                  ...
                  ch_0.Project(filen+"_unweighted","DiLeptonMass","1*( (Leading_Photon_pt/CMS_hgg_mass) > 1/3. && (Subleading_Photon_pt/CMS_hgg_mass) > 1/4. )")
                  ch_0.Project(filen+"_weighted","DiLeptonMass","weight*( (Leading_Photon_pt/CMS_hgg_mass) > 1/3. && (Subleading_Photon_pt/CMS_hgg_mass) > 1/4. )")
                  ...
                  #  hs.Add(hist)
                  #  c2.SaveAs(filen+".png")
                  out=TFile.Open("DiLeptonMass.root","UPDATE")
                  hist.Write()
